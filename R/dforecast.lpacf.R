...
{
# Like forecast.lpacf, but (i) differences data once, (ii) forecasts the
...
# Likewise, can only do one-step ahead. This function is a prototype.
    ...
    xd.f.l <- forecastLSW::forecast.lpacf(x=xd, h=1, regularize=regularize, lag.max=lag.max,
