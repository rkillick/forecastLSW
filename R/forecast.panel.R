forecast.panel=function(forecastobj,truth=NULL,add=FALSE,summary=TRUE,test="all",move=0,conf.level=95,col='red',pch=c(17,19,95),...){
  ...
  if(is(forecastobj,"forecast.lpacf")){
  ...
  else{stop("Invalid argument: forecastobj. \n Please provide either a vector of forecasts or an object of class 'forecast' or 'forecast.lpacf'.")}
